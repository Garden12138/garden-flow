...
const compatibility = new Set(['scripts/check-brand.cjs', 'branding/identity.json', 'desktop/shared/brand.generated.json', 'desktop/shared/brandEnvironment.sh', 'Plugin/brand.generated.json', 'Docs/GARDENFLOW_REBRAND.md']);
