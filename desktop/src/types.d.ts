  ...
  interface Window {
    ipcRenderer: {
      ...
      runtime: {
        ...
        }) => Promise<SessionRuntimeEventRecord[]>;
      ...
      send: (data: {
        ...
        taskHints?: {
          ...
          artifactType?: 'manuscript' | 'xiaohongshu-note';
          ...
          generationToolConstraints?: Record<string, unknown>;
        };
      }) => void;
      ...
      manuscripts: {
        ...
        getXhsNote: <T = unknown>(path: string) => Promise<T>;
        saveXhsNote: <T = unknown>(payload: Record<string, unknown>) => Promise<T>;
        bindXhsNoteMedia: <T = unknown>(payload: Record<string, unknown>) => Promise<T>;
        exportXhsMaterialPackage: <T = unknown>(payload: Record<string, unknown>) => Promise<T>;
      ...
      imageHosting: {
        testUpload: (payload?: { image_hosting_json?: string }) => Promise<{ ok?: boolean; publicUrl?: string; error?: string }>;
      };
      voice: {
      ...
      gardenflowRunner: {
        ...
        taskList: (payload?: { ownerScope?: string; includeDrafts?: boolean }) => Promise<{
          ...
          items?: Array<{
            ...
            sourceTaskId?: string | null;
            enabled: boolean;
            source?: 'manual' | 'chat' | 'builtin' | null;
            removable?: boolean;
