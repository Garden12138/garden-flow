...
export interface UploadedFileAttachment {
  ...
  /** Visible in the conversation, but excluded from chat-model runtime input. */
  displayOnly?: boolean;
}
...
export interface ChatSettingsSnapshot {
  ...
  ai_model_routes_json?: string | Record<string, unknown>;
...
export function buildChatModelOptions(settings?: ChatSettingsSnapshot | null): ChatModelOption[] {
  ...
  const chatRoute = (() => {
    const route = parseAiModelRoutesValue(settings.ai_model_routes_json).chat;
...
export const ChatComposer = forwardRef<ChatComposerHandle, ChatComposerProps>(function ChatComposer({
  ...
  const textEditorEditable = isChatComposerTextEditable({ readOnly, disabled, isBusy });
  ...
  const textarea = suppressed ? (
    ...
    >
      ...
      <div
        ref={textareaRef}
        contentEditable={textEditorEditable}
