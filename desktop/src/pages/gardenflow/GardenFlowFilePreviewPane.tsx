...
import { XhsNotePreviewPane } from './XhsNotePreviewPane';

interface GardenFlowFilePreviewPaneProps {
...
export function GardenFlowFilePreviewPane({
    target,
    onClose,
    onOpenExternal,
    onRevealInFolder,
    variant = 'card',
}: GardenFlowFilePreviewPaneProps) {
    ...
    const renderPreview = () => {
        if (target.artifactType === 'xiaohongshu-note' && target.xhsNote) {
            return <XhsNotePreviewPane target={target} />;
        }
