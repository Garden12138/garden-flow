...
export type RedClawHistorySessionActivity = 'running' | 'unread-complete' | 'failed';

type RedClawSidebarTab = 'chat' | 'manuscripts' | 'archived';
...
interface RedClawHistorySidebarSectionProps {
    ...
    archivedSessionList?: RedClawHistoryListItem[];
    archivedSessionsLoading?: boolean;
    onLoadArchivedSessions?: () => void | Promise<void>;
    onRestoreArchivedSession?: (session: RedClawHistoryListItem) => void | Promise<void>;
    onDeleteArchivedSession?: (session: RedClawHistoryListItem) => void | Promise<void>;
...
export function RedClawHistorySidebarSection({
    ...
    const restoreArchivedSession = async (session: RedClawHistoryListItem) => {
    ...
    const archiveSession = async (session: RedClawHistoryListItem) => {
    ...
    const deleteArchivedSession = async (session: RedClawHistoryListItem) => {
