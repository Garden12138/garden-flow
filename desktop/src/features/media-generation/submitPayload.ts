...
export function buildImageSubmitPayload(
    ...
    return {
        ...
        provider: options.routeOverride?.provider || options.provider || undefined,
        providerTemplate: options.routeOverride?.providerTemplate || options.providerTemplate || undefined,
...
export function buildVideoSubmitPayload(
    ...
    return {
        ...
        referenceImages: request.referenceItems.map((item) => item.dataUrl),
        referenceAudios: request.referenceAudios.map((item) => item.dataUrl),
