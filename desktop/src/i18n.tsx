...
const zhCN = {
  ...
  'workbench.create': '新建',
  'workbench.search': '搜索素材与稿件',
  'workbench.runningTasks': '运行任务',
  'workbench.create.newChat': '新对话',
  'workbench.create.importMaterial': '导入素材',
  'workbench.create.newManuscript': '新稿件',
  'workbench.create.mediaGeneration': '媒体生成',
  'workbench.create.automation': '自动化',
  'workbench.stage.home.summary': '今天要推进什么？从最近工作与待办继续。',
  'workbench.stage.collect.summary': '收集、整理并选择可复用的创作素材。',
  'workbench.stage.ideate.summary': '把素材转成可评价、可交接的内容方向。',
  'workbench.stage.compose.summary': '用简报、引用和对话完成稿件创作。',
  'workbench.stage.produce.summary': '管理生成配方、参考素材与异步结果。',
  'workbench.stage.assets.summary': '维护人物、产品与品牌资产的长期资料。',
  'workbench.stage.media.summary': '查看图片、视频与音频的生成结果。',
  'workbench.stage.schedule.summary': '安排自动化任务，并跟踪运行与异常。',
  ...
  'layout.openDownloadFailed': '应用内更新失败',
...
const enUS: Record<keyof typeof zhCN, string> = {
  ...
  'workbench.search': 'Search material and drafts',
  'workbench.runningTasks': 'Running tasks',
  'workbench.create.newChat': 'New chat',
  'workbench.create.importMaterial': 'Import material',
  'workbench.create.newManuscript': 'New manuscript',
  'workbench.create.mediaGeneration': 'Generate media',
  'workbench.create.automation': 'Automation',
  'workbench.stage.home.summary': 'Pick up recent work and decide what to move forward today.',
  'workbench.stage.collect.summary': 'Collect, organize, and select reusable source material.',
  'workbench.stage.ideate.summary': 'Turn material into directions that can be evaluated and handed off.',
  'workbench.stage.compose.summary': 'Create with a brief, visible references, and an AI collaborator.',
  'workbench.stage.produce.summary': 'Manage recipes, references, and asynchronous generation results.',
  'workbench.stage.assets.summary': 'Maintain durable people, product, and brand assets.',
  'workbench.stage.media.summary': 'Review generated images, video, and audio in one place.',
  'workbench.stage.schedule.summary': 'Schedule automations and follow running or exceptional work.',
  ...
  'layout.openDownloadFailed': 'In-app update failed',
