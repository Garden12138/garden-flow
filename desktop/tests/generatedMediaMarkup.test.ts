...
test('converts generated video HTML to the chat media Markdown contract', () => {
    const source = 'gardenflow-asset://asset//Users/example/media/generated/video.mp4';
    assert.equal(
...
test('supports nested audio sources and preserves fenced HTML examples', () => {
    const audioSource = 'gardenflow-asset://asset//Users/example/media/generated/audio.mp3';
    assert.match(
        normalizeGeneratedMediaMarkup(`<audio controls><source src='${audioSource}'></audio>`),
        /!\[generated-audio\]\(<gardenflow-asset:\/\/asset\/\/Users\/example\/media\/generated\/audio\.mp3>\)/,
    );
