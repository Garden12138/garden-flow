      ...
      for (const dir of dirs) {
        ...
        try {
          ...
          items.push({
            ...
            meta: {
              ...meta,
              sourceType: String(meta.captureKind || meta.type || 'note'),
              folderPath: path.join(redbookDir, dir.name),
              commentCount: Math.max(
                Array.isArray(meta.commentsSnapshot) ? meta.commentsSnapshot.length : 0,
                Number(meta.stats?.comments || 0),
              ),
            },
          });
        } catch {
        ...
        try {
          ...
          items.push({
            ...
            meta: {
              ...meta,
              sourceType: 'youtube',
              folderPath: path.join(youtubeDir, dir.name),
            },
          });
        } catch {
