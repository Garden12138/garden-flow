  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        interactionDelayMs: { type: 'number', minimum: 0, maximum: 10000 },
        scrollDelayMs: { type: 'number', minimum: 500, maximum: 5000 },
      ...
      properties: {
        ...
        reviewOptions: {
          ...
          properties: {
            ...
            interactionDelayMs: { type: 'number', minimum: 0, maximum: 5000 },
            scrollDelayMs: { type: 'number', minimum: 400, maximum: 5000 },
            maxScrollRounds: { type: 'number', minimum: 1, maximum: 12 },
          },
          additionalProperties: false,
        },
      ...
      case 'research.run':
        result = await runSiteResearch(normalized, {
          ...
          activateTab: async (tabId) => {
            const updated = await chrome.tabs.update(Number(tabId), { active: true });
            if (updated?.windowId) await chrome.windows.update(updated.windowId, { focused: true }).catch(() => {});
            return updated;
          },
          createControlledTab,
