...
export function createLocalCommandActionRouter(deps = {}) {
  ...
  router
    ...
    .register('capture.save', async ({ payload, session }) => runBrowserAction('capture.save', payload, session))
    .register('save-xhs', async ({ payload, session }) => runBrowserAction('capture.save', payload, session))
