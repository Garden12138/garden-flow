...
const FALLBACK_TOOLS = [
  ...
  browserTool('capture.save', 'Save the current page using the same plugin capture path as the in-page 保存笔记 button.', { tabId: { type: 'number' }, sessionId: { type: 'string' } }, ['tabId']),
