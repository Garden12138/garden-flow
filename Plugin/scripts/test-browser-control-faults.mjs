...
try {
  ...
  console.log(JSON.stringify({
    ...
    scenarios: [
      ...
      'native_host_semver_independent',
      'native_host_protocol_mismatch_rejected',
...
function testNativeHostVersionCompatibility() {
  ...
  assert.equal(
    assertNativeHostVersionCompatibility({ ...compatibleHandshake, appVersion: '2.6.11' }),
    true,
  );
  assert.equal(
    assertNativeHostVersionCompatibility({ ...compatibleHandshake, appVersion: '99.1.0' }),
    true,
  );
  assert.throws(
    () => assertNativeHostVersionCompatibility({ ...compatibleHandshake, bridgeProtocolVersion: 2 }),
